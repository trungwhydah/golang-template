...
type Pagination struct {
	OrderBy        string   `json:"orderBy" form:"orderBy" default:"createdAt"`
	OrderDirection string   `json:"orderDirection" form:"orderDirection" enums:"asc,desc" default:"desc"`
	Limit          int64    `json:"limit" form:"limit" default:"50"`
	Cursors        []string `json:"cursors" form:"cursors"`
}
...
func (p *Pagination) IsAsc() bool {
	return OrderDirectionType(p.OrderDirection) == AscOrderDirection
}
